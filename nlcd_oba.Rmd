...
nlcd_vector <- as.polygons(nlcd) 

plot(nlcd_vector)



# # Reclassification directly with mapValues
# reclass_values <- c(42, 43, 44, 71, 72)  # old classes
# new_values <- c(NA, 43, NA, 71, NA)      # corresponding new values
# 
# # Reclassify the vector
# nlcd_vector_classified <- mapValues(nlcd_vector, from = reclass_values, to = new_values, field = "land_cover_class")
# 
# # Check the result
# plot(nlcd_vector_classified, "land_cover_class")
