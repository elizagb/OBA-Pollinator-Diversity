...
colors <- c(
  ...
  "#CAB2D6", # lt purple
  "#FDBF6F", # lt orange
  "gray70", "orchid1", "blue1", "steelblue4",
...
ggplot() +
  ...
  # Plot the 500m buffers around OBA data
  geom_sf(data = buffers_500m, fill = "black", alpha = 0.3, color = "black") +
...
```{r}
# Next steps: 
    # Create boxplots to extract stats 
    # Group together some types of landcover 
